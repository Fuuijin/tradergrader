...
# Usage: curl -sSL https://raw.githubusercontent.com/fuuijin/tradergrader/main/scripts/install.sh | bash
...
while [[ $# -gt 0 ]]; do
	...
	-h | --help)
		...
		echo "  curl -sSL https://raw.githubusercontent.com/fuuijin/tradergrader/main/scripts/install.sh | bash"
		echo ""
		echo "  # Install to custom directory"
		echo "  curl -sSL https://raw.githubusercontent.com/fuuijin/tradergrader/main/scripts/install.sh | bash -s -- --dir /opt/tradergrader"
		exit 0
		;;
	*)
